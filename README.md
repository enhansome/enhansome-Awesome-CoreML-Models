...
If you've converted a Core ML model, feel free to submit a [pull request](https://github.com/likedan/Awesome-CoreML-Models/compare) ⭐ 7,045 | 🐛 15 | 🌐 Python | 📅 2025-06-17.

Recently, we've included visualization tools. And here's one [Netron](https://lutzroeder.github.io/Netron).

[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,449 | 🐛 105 | 📅 2026-08-21
...
* [TensorFlow Models](https://github.com/tensorflow/models) ⭐ 77,654 | 🐛 1,271 | 🌐 Python | 📅 2026-08-27 - Models for TensorFlow.
* [TensorFlow Slim Models](https://github.com/tensorflow/models/tree/master/research/slim/README.md) ⭐ 77,654 | 🐛 1,271 | 🌐 Python | 📅 2026-08-27 - Another collection of TensorFlow Models.
* [Caffe Model Zoo](https://github.com/BVLC/caffe/wiki/Model-Zoo) ⭐ 34,557 | 🐛 1,298 | 🌐 C++ | 📅 2024-07-31 - Big list of models in Caffe format.
...
* [See the guide](https://github.com/likedan/Awesome-CoreML-Models/blob/master/.github/CONTRIBUTING.md) ⭐ 7,045 | 🐛 15 | 🌐 Python | 📅 2025-06-17
